...
<header class="header wrap"><a class="brand" href="${base}index.html" aria-label="Bena Studies, início"><span class="brand-icon">b<span>✦</span></span><span>Bena<span class="brand-light">Studies</span></span></a><nav class="main-nav" aria-label="Principal"><a href="#materias">Explorar matérias</a></nav><button class="login" data-login>Entrar <span>↗</span></button></header>
