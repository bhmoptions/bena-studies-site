...
- Em `localhost`, os jogos operam sempre como prévia: não gravam depósito, pontuação normal ou reembolso e não exibem aviso de abandono. Esse desvio é restrito aos endereços de loopback; produção e previews da Vercel mantêm a persistência normal.
